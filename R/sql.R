    ...
    function(bfc)
{
    ...
    if (doit){
        ...
        if (any(!check)){
            ...
            warning(paste0(
                "Some web resources do not currently have rpath in cache.\n",
        ...
        message(paste0("Updating rpath for the following web resources:\n",
                       "  ", paste0("'", wid, "'", collapse=" ")))
        ...
        if (length(nonweb) != 0){
            message(paste0(
            "Updating last modified time for the following non web resources:\n",
